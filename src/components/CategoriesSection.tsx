      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {categories.map((category) => (
            <Card 
              key={category.title}
              className="group card-gradient border-border/60 hover:border-primary/30 transition-smooth hover:shadow-card overflow-hidden cursor-pointer"
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground reading-content">
